        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="about-heading-box box-shadow">
              <h1>Nhanh nhẹn, một quy trình mang lại giá trị <br> & thành công Các sản phẩm</h1>
            </div>
          </div>
        </div>
    ...
    <section id="some-fan-fact">
      ...
      <div class="container">
        <div class="heading-content-box">
          <h2>Một số sự kiện thú vị của chúng tôi</h2>
        </div>
        <div class="row aos-animate">
          <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="fact-box">
              ...
              <span class="counter">
              <?=get_option('option_project_finish') ?>
              </span>
          ...
          <div class="col-lg-3  col-md-6 col-sm-12 col-12">
            <div class="fact-box">
              ...
              <span class="counter">
                <?=get_option('option_project_avtive')?>
              </span>
          ...
          <div class="col-lg-3  col-md-6 col-sm-12 col-12">
            <div class="fact-box">
              ...
              <span class="counter">
              <?=get_option('option_passenger_please')?>
              </span>
          ...
          <div class="col-lg-3  col-md-6 col-sm-12 col-12">
            <div class="fact-box">
              ...
              <span class="counter">
              <?=get_option('option_years_experience')?>
              </span>
              <p>Năm kinh nghiệm</p>
            </div>
          </div>
